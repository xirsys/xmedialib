defmodule XMediaLib.RtpRtcpMuxedTest do
  ...
  @ntp <<_::size(64)>> = <<210, 79, 225, 24, 250, 129, 85, 222>>
  # valid SR packet
  @sr_bin <<130, 200, 0, 18, 0, 0, 16, 0, 210, 79, 225, 24, 250, 129, 85, 222, 0, 0, 16, 2, 0, 0,
            255, 255, 0, 1, 0, 0, @rblocks_bin::binary>>

  @xr_block1_bin <<254, 255, 0, 5, 116, 101, 115, 116, 49, 32, 120, 114, 98, 108, 111, 99, 107,
                   32, 100, 97, 116, 97, 32, 49>>
  @xr_block2_bin <<127, 128, 0, 5, 116, 101, 115, 116, 50, 32, 120, 114, 98, 108, 111, 99, 107,
                   32, 100, 97, 116, 97, 32, 50>>
  @xr_blocks_bin <<@xr_block1_bin::binary, @xr_block2_bin::binary>>
